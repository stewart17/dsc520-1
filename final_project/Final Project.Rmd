...
library(dplyr)
# import data
terrorism_db <- read.csv("C:/Users/stewa/Documents/GitHub/dsc520-1/final_project/data/globalterrorismdb.csv")
military_spending <- read.csv("C:/Users/stewa/Documents/GitHub/dsc520-1/final_project/data/MilitarySpending.csv")
...
summary(terror_lm)
scatter1 <- ggplot(war_cor, aes(x=DefenseBudget, y=n)) + geom_point(aes(color=iyear)) +  geom_smooth(method="lm") + xlab("Defense Budget") + ylab("Terrorist Attacks Per Year") + 
